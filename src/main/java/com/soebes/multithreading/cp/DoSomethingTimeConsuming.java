...
public class DoSomethingTimeConsuming implements Callable<Index> {
	private static final Logger LOGGER = Logger
			.getLogger(DoSomethingTimeConsuming.class);
	...
	public Index call() throws Exception {
		...
		String last = versionRange.getVersionRange().get(
				versionRange.getVersionRange().size() - 1);
		i.setName("number: " + number + " first:" + first + " last:" + last
