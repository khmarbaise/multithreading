    ...
    implements Callable<Index>
{
    ...
    public ScanVersionRange( RepositoryScanParameter repositoryScanParamter, RevisionRange revisionRange )
    {
        ...
        this.repository =
            new Repository( repositoryScanParamter.getUri(), SVNWCUtil.createDefaultAuthenticationManager() );
    ...
    /**
     * Will create a folder name out of the information about the VersionRange we have.
     * 
        ...
        throws Exception
    {
        ...
        ReadLogEntries readLogs =
            new ReadLogEntries( getRepository(), getRevisionRange().getFrom(), getRevisionRange().getTo() );
